...
import com.example.furnitureFactory.repository.sheetMaterial.SheetMaterialRepository;
...
public class CommonSheetMaterialServiceImpl extends SheetMaterialServiceImpl<SheetMaterial, SheetMaterialRepository> {
    ...
    public boolean findAllByProductSchema(List<SheetMaterial> schema) {
        /**
         * Method findAllByProductSchema returns true if there are all materials in the warehouse.
         */
        boolean b = true;
        ...
        for (SheetMaterial material : schema) {
            ...
            if ((sheetMaterial.getMaterialsCount() < material.getMaterialsCount()) || (sheetMaterial == null)) {
                b = false;
            }
